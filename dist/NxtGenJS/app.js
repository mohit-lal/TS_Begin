...
// console.log(result);
// Arrow function
const addM = (a, b = 1) => a + b; // for 1 expression no need for curly braces
const addN = (a, b) => {
    return a + b;
};
// console.log(addM(5,6));
const pringOutput = output => console.log(output);
...
const copiedPerson = Object.assign({}, personA); // Copies the whole object with key value pair rather than a pointer
// Rest parameters
const addSprd = (...numbers) => {
